...
const ctaAlignClass = alignMap[align];
    ...
    return (
      <BaseCard color={color}>
        ...
        <div className="flex items-center gap-4">
          {/* Avatar */}
          {image && <div className="w-12 h-12 rounded-full overflow-hidden flex-shrink-0">
            {image}
          </div>}
  ...
  if (view=="stats") {
    // Stats layout
    return (
            <BaseCard color={color} className="text-center flex flex-col items-center">
        {image && <div className="w-16 h-16 flex items-center justify-center rounded-full mb-4 bg-primary/20">
