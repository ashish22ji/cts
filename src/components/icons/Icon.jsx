...
export const StarIcon = ({ width = 24, height = 24, color = "currentColor" }) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <path d="M12 2L15 8L22 9L17 14L18 21L12 18L6 21L7 14L2 9L9 8L12 2Z" fill={color} />
  </svg>
);

export const ChevronLeft = ({ width = 16, height = 16, color = "currentColor" }) => (
...
export const ChevronRight = ({ width = 16, height = 16, color = "currentColor" }) => (
  <svg width={width} height={height} viewBox="0 0 9 15" fill="none">
    <path d="M1.266 13.9L7.666 7.5" stroke={color} strokeWidth={2.5} strokeLinecap="round" />
    <path d="M7.667 7.5L1.267 1.1" stroke={color} strokeWidth={2.5} strokeLinecap="round" />
  </svg>
);

export const EmailIcon = ({ width = 24, height = 24, color = "currentColor" }) => (
