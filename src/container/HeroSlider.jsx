          ...
          >
            ...
            <div className="relative z-10 h-full flex items-center px-20">
              <div className="text-white max-w-xl">
                ...
                <CTA text="Get a Quote" variant="primary" target="_blank" href={`https://wa.me/${contactData.phone}?text=${encodeURIComponent(`${contactData.quoteMessage}-"${fleetItem.quoteInfo}"`)}`}/>
              </div>
            </div>
          </div>
        </SwiperSlide>
